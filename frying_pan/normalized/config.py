...
from frying_pan.normalized.references import Conflict, Dependency, Reference
from frying_pan.normalized.rules import Rulebase, SecurityRule
...
class NormalizedConfig(BaseModel):
    ...
    rulebases: list[Rulebase] = Field(default_factory=list)
